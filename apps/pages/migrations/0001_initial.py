    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao_3', models.CharField(blank=True, help_text='Descrição mais curta até 200 caracteres', max_length=200, null=True)),
                ('descricao_4', models.TextField(blank=True, help_text='Descrição mais longa', null=True)),
                ('titulo_botao_1', models.CharField(blank=True, help_text='Titulo do Botão 1', max_length=250, null=True)),
                ('rota_botao_1', models.CharField(blank=True, help_text='Nome da Rota que configurou no urls.py', max_length=400, null=True)),
                ('titulo_botao_2', models.CharField(blank=True, help_text='Titulo do Botão 2', max_length=250, null=True)),
                ('rota_botao_2', models.CharField(blank=True, help_text='Nome da Rota que configurou no urls.py', max_length=400, null=True)),
            ],
            options={
